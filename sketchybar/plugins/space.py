...
ICON_MAP = [
    ...
    {"regex": r"Alacritty|Hyper|iTerm2|kitty|Terminal", "icon": ":terminal:"},
    {"regex": r"WezTerm", "icon": ":kitty:"},
    ...
    {"regex": r"Calendar|Fantastical|Cron|Morgen|BusyCal", "icon": ":calendar:"},
    ...
    {"regex": r"Zen Browser", "icon": ":zen_browser:"},
